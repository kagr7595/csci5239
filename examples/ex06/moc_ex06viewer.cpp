...
struct qt_meta_stringdata_Ex06viewer_t {
    QByteArrayData data[3];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Ex06viewer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Ex06viewer_t qt_meta_stringdata_Ex06viewer = {
    {
QT_MOC_LITERAL(0, 0, 10), // "Ex06viewer"
...
const QMetaObject Ex06viewer::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Ex06viewer.data,
      qt_meta_data_Ex06viewer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Ex06viewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Ex06viewer.stringdata0))
