...
{
   //  Set window title
   setWindowTitle(tr("Ex17: Types of Noise"));
   ...
   shader->addItem("None");
   shader->addItem("2D Classic Noise");
   shader->addItem("2D Simplex Noise");
   shader->addItem("3D Classic Noise");
   shader->addItem("3D Simplex Noise");
   shader->addItem("4D Classic Noise");
   shader->addItem("4D Simplex Noise");
