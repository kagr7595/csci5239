...
void Ex17opengl::paintGL()
{
   ...
   if (mode)
   {
      ...
      shader[0]->setUniformValue("SimpTex",1);
      shader[0]->setUniformValue("PermTex",2);
      shader[0]->setUniformValue("GradTex",3);
   }
